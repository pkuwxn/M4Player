...
wxString GetKeyCodeName(int keycode)
{
	...
	switch( keycode )
	{
	case WXK_SHIFT:					return L"Shift";
	case WXK_ALT:					return L"Alt";
	case WXK_CONTROL:				return L"Ctrl";
	case WXK_WINDOWS_MENU:			return L"Windows Menu";
	case WXK_TAB:					return L"Tab";
	case WXK_ESCAPE:				return L"Esc";
	case WXK_CAPITAL:				return L"Caps Lock";
	...
	case WXK_NUMLOCK:				return L"Num Lock";
	case WXK_SCROLL:				return L"Scroll Lock";
	case WXK_NUMPAD_MULTIPLY:		return L"Num *";
	case WXK_NUMPAD_ADD:			return L"Num +";
	case WXK_NUMPAD_SEPARATOR:		return L"Num !";
	case WXK_NUMPAD_SUBTRACT:		return L"Num -";
	case WXK_NUMPAD_DECIMAL:		return L"Num ~";
	case WXK_NUMPAD_DIVIDE:			return L"Num /";
...
const wxChar* GetEventName(int evtCode)
{
	...
	case HOVERING:					return L"HOVERING";
	case LEFT_DOWN:					return L"LEFT_DOWN";
	case LEFT_UP:					return L"LEFT_UP";
	case DLEFT_DOWN:				return L"DLEFT_DOWN";
	case RIGHT_UP:					return L"RIGHT_UP";
	case DRAGGING:					return L"DRAGGING";
	case WHEEL_UP:					return L"WHEEL_UP";
	case WHEEL_DOWN:				return L"WHEEL_DOWN";
	case SCROLLING_UP:				return L"SCROLLING_UP";
	case SCROLLING_DOWN:			return L"SCROLLING_DOWN";
	case MOUSE_LEAVE:				return L"MOUSE_LEAVE";
	case MOUSE_LEAVE_WINDOW:		return L"MOUSE_LEAVE_WINDOW";
	case MOUSE_HOLD_ON_RELEASED:	return L"MOUSE_HOLD_ON_RELEASED";
...
const wxChar* GetNoticeName(int notice)
{
	switch( notice )
	{
	case VCN_CREATE:				return L"VCN_CREATE";
	case VCN_DESTROY:				return L"VCN_DESTROY";
	case VCN_SIZE_CHANGED:			return L"VCN_SIZE_CHANGED";
	case VCN_FONT_CHANGED:			return L"VCN_FONT_CHANGED";
	case VCN_SHOW:					return L"VCN_SHOW";
	case VCN_HIDE:					return L"VCN_HIDE";
	case VCN_THAW:					return L"VCN_THAW";
	case VCN_FREEZE:				return L"VCN_FREEZE";
	case VCN_ENABLED:				return L"VCN_ENABLED";
	case VCN_DISABLED:				return L"VCN_DISABLED";
	case VCN_MENU_HID:				return L"VCN_MENU_HID";
