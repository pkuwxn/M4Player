...
public:
    ...
    wxMouseEvent *GetNativeEventObj() const {
        return m_nativeEventObj;
    }
...
public:
    ...
    /// \brief 获取通知标识符
    VdkCtrlNotifyCode GetNotifyCode() const {
        return m_notice;
    }
...
#   endif
    ...
    /// \brief 获取 DC
    void SetVObjDC(wxDC *pDC) {
        m_pDC = pDC;
    }

    /// \brief 获取 DC
    wxDC *GetVObjDC() const {
        return m_pDC;
    }
...
public:
    ...
    public:
        ...
        /// \brief 获取鼠标事件对象
        const wxMouseEvent &mouseEvent() const {
            return m_mouseEvent;
        }
...
public:
    ...
    /// \brief 设置菜单项句柄
    void SetMenuItem(VdkMenuItem *item) {
        m_menuItem = item;
    }
