...
namespace MyTagLib
{
	...
	String Lyrics3v2::doGetArtist() const { return EmptyString; }
	String Lyrics3v2::doGetTitle() const { return EmptyString; }
	String Lyrics3v2::doGetAlbum() const { return EmptyString; }
	String Lyrics3v2::doGetYear() const { return EmptyString; }
	String Lyrics3v2::doGetComment() const { return EmptyString; }
	int Lyrics3v2::doGetTrackNumber() const { return TRACK_NUMBER_NOT_SET; }
	Genre Lyrics3v2::doGetGenre() const { return Genre::GENRE_NOT_SET; }

	bool Lyrics3v2::doSetArtist(const String& Artist) { return false; }
	bool Lyrics3v2::doSetTitle(const String& Title) { return false; }
	bool Lyrics3v2::doSetAlbum(const String& String) { return false; }
	bool Lyrics3v2::doSetYear(const String& Year) { return false; }
	bool Lyrics3v2::doSetComment(const String& Comment) { return false; }
	bool Lyrics3v2::doSetTrackNumber(int TrackNumber) { return false; }
	bool Lyrics3v2::doSetGenre(const Genre& genre) { return false; }
